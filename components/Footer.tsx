      ...
      <div className="container mx-auto flex flex-col md:flex-row gap-0 justify-between p-6 md:py-10 md:px-7">
        ...
        <div className="w-full md:w-[14%] mb-8 pl-1 md:pl-8 md:pt-10">
          ...
          <ul className="space-y-2 pl-1">
            <li>
              <Link
                href="/packages/classical-delhi-jaipur-agra-khajurao-varanasi-tour-india"
                className="hover:text-blue-600 transition-colors"
              >
                Delhi
              </Link>
            ...
            <li>
              <Link
                href="/packages/forts-of-rajasthan-from-delhi-11-days-package-india"
                className="hover:text-blue-600 transition-colors"
              >
                Jaipur
              </Link>
            ...
            <li>
              <Link
                href="/packages/golden-triangle-delhi-agra-jaipur-7-days-package-india"
                className="hover:text-blue-600 transition-colors"
              >
                Agra
              </Link>
            ...
            <li>
              <Link
                href="/packages/north-india-temple-tour-package-india"
                className="hover:text-blue-600 transition-colors"
              >
                Varanasi
              </Link>
            ...
            <li>
              <Link
                href="/packages/golden-chariot-bangalore-mysore-goa-tour-package-india"
                className="hover:text-blue-600 transition-colors"
              >
                Goa
              </Link>
        ...
        <div className="w-full md:w-[20%] mb-8 pl-1 md:pl-1 md:pt-10">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start space-x-2">
              ...
              <p className="text-sm">
                <a href="https://maps.app.goo.gl/H7RTSzRAnT3WYnjr9" className="hover:text-blue-600">
