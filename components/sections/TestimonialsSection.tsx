...
const TestimonialsSection = ({ locale = "en" }: TestimonialsSectionProps) => {
  ...
  const { testimonials } = translations.landing;
  ...
  return (
    <>
      ...
      >
        <div className="sm:min-w-[600px] bg-black p-8 pb-12 rounded-[23px] text-left">
          <h2 className="text-white text-[32px] sm:text-[40px] mb-4 font-semibold leading-[1.2em]">
            Subscribe & Get 20% off
          </h2>
          <p className="text-white mb-6">
            Subscribe to our newsletter and get the latest updates and exclusive offers.
          </p>
